...
//  ㄴ 전 블럭의 번호를 구해라 * 전블럭의 전체 수를 구하고 + 1을 더해라 	
	...
	//ㄴ 12 까직 밖에 없는데 15라 넘겨 버릴경우에  totalPage 값을 강제로 변환 해줘 
	...
	if(currentBlockNo == 1){	//현재 블럭이 1번 블럭이면
		hasPrev = false;		//이전 블럭 가기 불가능 -1 총페이지로 못가게끔 하기
		...
		// 2번째 블럭일때 2-1을 한뒤에 블럭당 있는 페이지(5)를 곱해서 표시하기
